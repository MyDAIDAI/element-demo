 ...
 * @returns {CombinedVueInstance<CombinedVueInstance<Vue, any, any, any, Record<never, any>> & Vue, Object, Object, Object, Record<never, any>>}
 */
...
/**
 * 触发一个事件
 * mouseenter, mouseleave, mouseover, keyup, change, click等
 * @param elm
 * @param name
 * @param opts
 * @returns {*}
